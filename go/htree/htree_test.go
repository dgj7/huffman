...
func TestToTreeScenario1(t *testing.T) {
    ...
    assert.Equal(t, "011011", encodings['c'].ToString(), "encoding wrong")// fails; this is correct!
    assert.Equal(t, "111", encodings[' '].ToString(), "encoding wrong")
    assert.Equal(t, "01001", encodings['m'].ToString(), "encoding wrong")
    assert.Equal(t, "101000", encodings['l'].ToString(), "encoding wrong")// fails; this is correct!
    ...
    assert.Equal(t, "011010", encodings['b'].ToString(), "encoding wrong")// fails; this is correct!
    ...
    assert.Equal(t, "101001", encodings['x'].ToString(), "encoding wrong")// fails; this is correct!
